...
abstract class FlutterTransformer {
...
class FlutterTarget extends VmTarget {
  ...
  static List<FlutterTransformer> transformers = [];
  ...
  void performPreConstantEvaluationTransformations(
    ...
    for(FlutterTransformer transformer in transformers){
      transformer.transform(component, logger: logger);
    }
