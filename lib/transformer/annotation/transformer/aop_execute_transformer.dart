...
class AopExecuteTransformer extends Transformer {
  AopExecuteTransformer(
      this.infoList, this.libraryMap, this.uriToSource);
...
//          && procedure.function.typeParameters.isEmpty
  ...
  void aopTransform() {
    for (AopItemInfo aopItemInfo in infoList) {
      final Set<Library> filteredLibraries =
          _filterLibraryWithAopItemInfo(libraryMap, aopItemInfo);
              ...
              if (filteredMember is Constructor) {
                ...
                if (filteredMember.function.body == null) {
                  filteredMember = _filterFirstMatchPatchClassMember(
                      libraryMap, filteredMember, aopItemInfo)!;
                }
  ...
  void transformConstructor(Library originalLibrary, Constructor constructor,
    ...
    LibraryManager.share.proceedProcedure!.parent!.parent as Library;
    final Class pointcutClass = LibraryManager.share.proceedProcedure!.parent as Class;
  ...
  Block createPointcutCallFromOriginal(
    ...
    final Map<String, String> sourceInfo =
        AopUtils.calcSourceInfo(uriToSource, library, 0);
