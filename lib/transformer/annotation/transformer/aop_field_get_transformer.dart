...
class AopFieldGetTransformer extends Transformer {
  AopFieldGetTransformer(this.infoList);
  ...
  Expression visitStaticGet(StaticGet node) {
    ...
    final AopItemInfo aopItemInfo = _filterAopItemInfo(
        infoList, importUri!, clsName!, fieldName!, true)!;
  ...
  Expression visitInstanceGet(InstanceGet node) {
    ...
    final AopItemInfo aopItemInfo = _filterAopItemInfo(
        infoList, importUri, clsName, fieldName, false)!;
